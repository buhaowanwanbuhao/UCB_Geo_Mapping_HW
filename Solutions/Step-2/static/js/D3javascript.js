...
(function (t, n) {
	...
	function Gr(t, n, e, r, i, o, u) {
		var a, c, s, f = {},
			...
			h = o.length,
			p = new Array(l);
		for (a = 0; a < l; ++a)(c = n[a]) && (p[a] = s = I_ + u.call(c, c.__data__, a, n), s in f ? i[a] = c : f[s] = c);
		for (a = 0; a < h; ++a) s = I_ + u.call(t, o[a], a, o), (c = f[s]) ? (r[a] = c, c.__data__ = o[a], f[s] = null) : e[a] = new $r(t, o[a]);
	...
	function qi(t, n) {
		...
		if (!e || !(e = e[n]) || e.state > my) throw new Error("too late");
		return e
	}

	function Li(t, n) {
		var e = t.__transition;
		if (!e || !(e = e[n]) || e.state > by) throw new Error("too late");
		return e
	}
	...
	function Ui(t, n, e) {
		function r(t) {
			e.state = xy, e.timer.restart(i, e.delay, e.time), e.delay <= t && i(t - e.delay)
		}

		function i(r) {
			var s, f, l, h;
			if (e.state !== xy) return u();
			for (s in c)
				if (h = c[s], h.name === e.name) {
					if (h.state === wy) return sd(i);
					h.state === My ? (h.state = Ny, h.timer.stop(), h.on.call("interrupt", t, t.__data__, h.index, h.group), delete c[s]) : +s < n && (h.state = Ny, h.timer.stop(), delete c[s])
				}
			if (sd(function () {
					e.state === wy && (e.state = My, e.timer.restart(o, e.delay, e.time), o(r))
				}), e.state = by, e.on.call("start", t, t.__data__, e.index, e.group), e.state === by) {
				for (e.state = wy, a = new Array(l = e.tween.length), s = 0, f = -1; s < l; ++s)(h = e.tween[s].value.call(t, t.__data__, e.index, e.group)) && (a[++f] = h);
				a.length = f + 1
			}
		}

		function o(n) {
			for (var r = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(u), e.state = Ty, 1), i = -1, o = a.length; ++i < o;) a[i].call(null, r);
			e.state === Ty && (e.on.call("end", t, t.__data__, e.index, e.group), u())
		}

		function u() {
			e.state = Ny, e.timer.stop(), delete c[n];
	...
	function eo(t, n) {
		var e, r, i;
		return function () {
			var o = K_(this).getComputedStyle(this, null),
	...
	function io(t, n, e) {
		var r, i;
		return function () {
			var o = K_(this).getComputedStyle(this, null).getPropertyValue(t);
			return o === e ? null : o === r ? i : i = n(r = o, e)
		}
	}
	...
	function oo(t, n, e) {
		var r, i, o;
		return function () {
			var u = K_(this).getComputedStyle(this, null),
	...
	function ho(t, n) {
		for (var e; !(e = t.__transition) || !(e = e[n]);)
			if (!(t = t.parentNode)) return Gy.time = jn(), Gy;
		return e
	}
	...
	function go(t, n) {
		function e(e) {
			var s, f = null == i ? n.ticks ? n.ticks.apply(n, r) : n.domain() : i,
				l = null == o ? n.tickFormat ? n.tickFormat.apply(n, r) : ng : o,
				h = Math.max(u, 0) + c,
				p = t === eg || t === ig ? po : vo,
				d = n.range(),
				v = d[0] + .5,
				_ = d[d.length - 1] + .5,
				y = (n.bandwidth ? _o : ng)(n.copy()),
				...
				T = x.select("text"),
				N = t === eg || t === og ? -1 : 1,
				k = t === og || t === rg ? (s = "x", "y") : (s = "y", "x");
			m = m.merge(m.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "#000")), x = x.merge(w), M = M.merge(w.append("line").attr("stroke", "#000").attr(s + "2", N * u).attr(k + "1", .5).attr(k + "2", .5)), T = T.merge(w.append("text").attr("fill", "#000").attr(s, N * h).attr(k, .5).attr("dy", t === eg ? "0em" : t === ig ? "0.71em" : "0.32em")), e !== g && (m = m.transition(e), x = x.transition(e), M = M.transition(e), T = T.transition(e), b = b.transition(e).attr("opacity", ug).attr("transform", function (t) {
				return p(y, this.parentNode.__axis || y, t)
			}), w.attr("opacity", ug).attr("transform", function (t) {
				return p(this.parentNode.__axis || y, y, t)
			})), b.remove(), m.attr("d", t === og || t == rg ? "M" + N * a + "," + v + "H0.5V" + _ + "H" + N * a : "M" + v + "," + N * a + "V0.5H" + _ + "V" + N * a), x.attr("opacity", 1).attr("transform", function (t) {
				return p(y, y, t)
			}), M.attr(s + "2", N * u), T.attr(s, N * h).text(l), g.filter(yo).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === rg ? "start" : t === og ? "end" : "middle"), g.each(function () {
				this.__axis = y
			})
		}
		var r = [],
		...
		return e.scale = function (t) {
			...
			return r = tg.call(arguments), e
		}, e.tickArguments = function (t) {
			return arguments.length ? (r = null == t ? [] : tg.call(t), e) : r.slice()
		}, e.tickValues = function (t) {
			return arguments.length ? (i = null == t ? null : tg.call(t), e) : i && i.slice()
	...
	function Wo(t) {
		...
		for (r = mg(n), a = 0; a < i; ++a) n = t[a], n.x -= r.x, n.y -= r.y;
		return r.r
	}
	...
	function lu(t, n, e, r, i, o) {
		for (var u, a, c, s, f, l, h, p, d, v, _, y, g = [], m = n.children, x = 0, b = m.length, w = n.value; x < b;) {
			...
			}), u.dice ? Tg(u, e, r, i, w ? r += f * l / w : o) : zg(u, e, r, w ? e += s * l / w : i, o), w -= l, x = c
		}
		return g
	}
	...
	function gu(t, n) {
		var e = t.document.documentElement,
			r = py(t).on("dragstart.drag", null);
		n && (r.on("click.drag", Zg, !0), setTimeout(function () {
	...
	function Cu(t, n, e, r) {
		var i = [null, null],
			o = im.push(i) - 1;
		return i.left = t, i.right = n, e && Pu(i, t, n, e), r && Pu(i, n, t, r), em[t.index].halfedges.push(o), em[n.index].halfedges.push(o), i
	}
	...
	function Ru(t, n, e, r) {
		for (var i, o = im.length; o--;) Lu(i = im[o], t, n, e, r) && qu(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > am || Math.abs(i[0][1] - i[1][1]) > am) || delete im[o]
	}
	...
	function Iu() {
		for (var t, n, e, r, i = 0, o = em.length; i < o; ++i)
			if ((t = em[i]) && (r = (n = t.halfedges).length)) {
				var u = new Array(r),
					a = new Array(r);
				for (e = 0; e < r; ++e) u[e] = e, a[e] = Du(t, im[n[e]]);
	...
	function Yu(t, n, e, r) {
		var i, o, u, a, c, s, f, l, h, p, d, v, _ = em.length,
			y = !0;
		for (i = 0; i < _; ++i)
			if (o = em[i]) {
				for (u = o.site, c = o.halfedges, a = c.length; a--;) im[c[a]] || c.splice(a, 1);
				for (a = 0, s = c.length; a < s;) p = Fu(o, im[c[a]]), d = p[0], v = p[1], f = Ou(o, im[c[++a % s]]), l = f[0], h = f[1], (Math.abs(d - l) > am || Math.abs(v - h) > am) && (c.splice(a, 0, im.push(zu(u, p, Math.abs(d - t) < am && r - v > am ? [t, Math.abs(l - t) < am ? h : r] : Math.abs(v - r) < am && e - d > am ? [Math.abs(h - r) < am ? l : e, r] : Math.abs(d - e) < am && v - n > am ? [e, Math.abs(l - e) < am ? h : n] : Math.abs(v - n) < am && d - t > am ? [Math.abs(h - n) < am ? l : t, n] : null)) - 1), ++s);
				s && (y = !1)
			}
		if (y) {
			var g, m, x, b = 1 / 0;
			for (i = 0, y = null; i < _; ++i)(o = em[i]) && (u = o.site, g = u[0] - t, m = u[1] - n, x = g * g + m * m, x < b && (b = x, y = o));
			if (y) {
				var w = [t, n],
					M = [t, r],
					T = [e, r],
					N = [e, n];
				y.halfedges.push(im.push(zu(u = y.site, w, M)) - 1, im.push(zu(u, M, T)) - 1, im.push(zu(u, T, N)) - 1, im.push(zu(u, N, w)) - 1)
			}
		}
		for (i = 0; i < _; ++i)(o = em[i]) && (o.halfedges.length || delete em[i])
	}
	...
	function Hu(t) {
		var n = t.circle;
		n && (n.P || (tm = n.N), rm.remove(n), om.push(n), ku(n), t.circle = null)
	}
	...
	function Wu(t) {
		Hu(t), nm.remove(t), um.push(t), ku(t)
	}
	...
	function $u(t) {
		var n = t.circle,
			...
			a = [t];
		Wu(t);
		for (var c = o; c.circle && Math.abs(e - c.circle.x) < am && Math.abs(r - c.circle.cy) < am;) o = c.P, a.unshift(c), Wu(c), c = o;
		a.unshift(c), Hu(c);
		for (var s = u; s.circle && Math.abs(e - s.circle.x) < am && Math.abs(r - s.circle.cy) < am;) u = s.N, a.push(s), Wu(s), s = u;
		a.push(s), Hu(s);
		var f, l = a.length;
	...
	function Zu(t) {
		for (var n, e, r, i, o = t[0], u = t[1], a = nm._; a;)
			if (r = Gu(a, u) - o, r > am) a = a.L;
			else {
				if (i = o - Ju(a, u), !(i > am)) {
					r > -am ? (n = a.P, e = a) : i > -am ? (n = a, e = a.N) : n = e = a;
					break
				}
				if (!a.R) {
					n = a;
		...
		Uu(t);
		var c = Vu(t);
		if (nm.insert(n, c), n || e) {
			if (n === e) return Hu(n), e = Vu(n.site), nm.insert(c, e), c.edge = e.edge = Cu(n.site, c.site), ju(n), void ju(e);
	...
	function ta(t, n) {
		...
		for (im = [], em = new Array(t.length), nm = new Nu, rm = new Nu;;)
			if (i = tm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (Zu(o), e = o[0], r = o[1]), o = t.pop();
			else {
				if (!i) break;
				$u(i.arc)
			}
		...
		this.edges = im, this.cells = em, nm = rm = im = em = null
	}
	...
	function ya(n) {
		function e(t) {
			...
			e.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", Tm.overlay).merge(e).each(function () {
				var t = ha(this).extent;
				py(this).attr("x", t[0][0]).attr("y", t[0][1]).attr("width", t[1][0] - t[0][0]).attr("height", t[1][1] - t[0][1])
			}), t.selectAll(".selection").data([sa("selection")]).enter().append("rect").attr("class", "selection").attr("cursor", Tm.selection).attr("fill", "#777").attr("fill-opacity", .3).attr("stroke", "#fff").attr("shape-rendering", "crispEdges");
		...
		function u() {
			function e() {
				var t = z_(T);
				!U || w || M || (Math.abs(t[0] - O[0]) > Math.abs(t[1] - O[1]) ? M = !0 : w = !0), O = t, b = !0, _m(), o()
			}
			...
			function o() {
				...
				_ < h && (S *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, N in Nm && Y.attr("cursor", Tm[N = Nm[N]])), g < d && (A *= -1, t = p, p = y, y = t, t = d, d = g, g = t, N in km && Y.attr("cursor", Tm[N = km[N]])), z = E.selection, w && (h = z[0][0], _ = z[1][0]), M && (d = z[0][1], g = z[1][1]), z[0][0] === h && z[0][1] === d && z[1][0] === _ && z[1][1] === g || (E.selection = [
					[h, d],
					[_, g]
				], r.call(T), F.brush())
			}
			...
			function u() {
				...
				I.attr("pointer-events", "all"), Y.attr("cursor", Tm.overlay), pa(z) && (E.selection = null, r.call(T)), F.end()
			}
			...
			function a() {
				switch (t.event.keyCode) {
					case 16:
						...
						break;
					case 18:
						k === mm && (S && (v = _ - m * S, l = h + m * S), A && (y = g - x * A, p = d + x * A), k = xm, o());
						break;
					case 32:
						k !== mm && k !== xm || (S < 0 ? v = _ - m : S > 0 && (l = h - m), A < 0 ? y = g - x : A > 0 && (p = d - x), k = gm, Y.attr("cursor", Tm.selection), o());
						break;
					default:
						return
				}
			...
			function s() {
				switch (t.event.keyCode) {
					case 16:
						...
						break;
					case 18:
						k === xm && (S < 0 ? v = _ : S > 0 && (l = h), A < 0 ? y = g : A > 0 && (p = d), k = mm, o());
						break;
					case 32:
						k === gm && (t.event.altKey ? (S && (v = _ - m * S, l = h + m * S), A && (y = g - x * A, p = d + x * A), k = xm) : (S < 0 ? v = _ : S > 0 && (l = h), A < 0 ? y = g : A > 0 && (p = d), k = mm), Y.attr("cursor", Tm[N]), o());
						break;
					default:
						return
				}
			...
			if (t.event.touches) {
				if (t.event.changedTouches.length < t.event.touches.length) return _m()
			} else if (c) return;
			if (f.apply(this, arguments)) {
				var l, h, p, d, v, _, y, g, m, x, b, w, M, T = this,
					N = t.event.target.__data__.type,
					k = "selection" === (t.event.metaKey ? N = "overlay" : N) ? ym : t.event.altKey ? xm : mm,
					S = n === wm ? null : Sm[N],
					A = n === bm ? null : Am[N],
					E = ha(T),
					C = E.extent,
				...
				"overlay" === N ? E.selection = z = [
					[l = n === wm ? P : D[0], p = n === bm ? q : D[1]],
					[v = n === wm ? L : l, y = n === bm ? R : p]
				] : (l = z[0][0], p = z[0][1], v = z[1][0], y = z[1][1]), h = l, d = p, _ = v, g = y;
				var I = py(T).attr("pointer-events", "none"),
					Y = I.selectAll(".overlay").attr("cursor", Tm[N]);
				if (t.event.touches) I.on("touchmove.brush", e, !0).on("touchend.brush touchcancel.brush", u, !0);
				else {
					var B = py(t.event.view).on("keydown.brush", a, !0).on("keyup.brush", s, !0).on("mousemove.brush", e, !0).on("mouseup.brush", u, !0);
					Gg(t.event.view)
				}
				ca(), Sy(T), r.call(T), F.start()
			}
		}
		...
		return e.move = function (t, e) {
			t.selection ? t.on("start.brush", function () {
				...
				var t = this,
					...
					c = i(t, o).beforestart();
				Sy(t), u.selection = null == a || pa(a) ? null : a, r.call(t), c.start().brush().end()
			})
		}, o.prototype = {
			...
			emit: function (t) {
				Xr(new vm(e, t, n.output(this.state.selection)), l.apply, l, [t, this.that, this.args])
			}
		}, e.extent = function (t) {
			return arguments.length ? (s = "function" == typeof t ? t : dm([
				[+t[0][0], +t[0][1]],
				[+t[1][0], +t[1][1]]
			]), e) : s
		}, e.filter = function (t) {
			return arguments.length ? (f = "function" == typeof t ? t : dm(!!t), e) : f
	...
	function ka(t) {
		return t > 1 ? 0 : t < -1 ? bx : Math.acos(t)
	}

	function Sa(t) {
		return t > 1 ? wx : t < -1 ? -wx : Math.asin(t)
	}
	...
	function Ca(t, n) {
		t && Ix.hasOwnProperty(t.type) && Ix[t.type](t, n)
	}
	...
	function Ra(t, n) {
		Hx.point = Ua, Ym = t, Bm = n, t *= kx, n *= kx, jm = t, Hm = Cx(n = n / 2 + Mx), Xm = Rx(n)
	}
	...
	function Ua(t, n) {
		...
		var e = t - jm,
			...
			c = Hm * o + a * Cx(i),
			s = a * r * Rx(i);
		Bx.add(Ex(s, c)), jm = t, Hm = o, Xm = u
	}

	function Da(t) {
		return [Ex(t[1], t[0]), Sa(t[2])]
	}
	...
	function ja(t) {
		var n = Dx(t[0] * t[0] + t[1] * t[1] + t[2] * t[2]);
		t[0] /= n, t[1] /= n, t[2] /= n
	}

	function Ha(t, n) {
		tx.push(nx = [Vm = t, $m = t]), n < Wm && (Wm = n), n > Zm && (Zm = n)
	}
	...
	function Xa(t, n) {
		...
		if (Km) {
			...
			var u, a = t - Gm,
				...
				s = o[0] * Nx * c,
				f = Sx(a) > 180;
			f ^ (c * Gm < s && s < c * t) ? (u = o[1] * Nx, u > Zm && (Zm = u)) : (s = (s + 360) % 360 - 180, f ^ (c * Gm < s && s < c * t) ? (u = -o[1] * Nx, u < Wm && (Wm = u)) : (n < Wm && (Wm = n), n > Zm && (Zm = n))), f ? t < Gm ? Ja(Vm, t) > Ja(Vm, $m) && ($m = t) : Ja(t, $m) > Ja(Vm, $m) && (Vm = t) : $m >= Vm ? (t < Vm && (Vm = t), t > $m && ($m = t)) : t > Gm ? Ja(Vm, t) > Ja(Vm, $m) && ($m = t) : Ja(t, $m) > Ja(Vm, $m) && (Vm = t)
		} else Ha(t, n);
		Km = e, Gm = t
	}
	...
	function Wa() {
		nx[0] = Vm, nx[1] = $m, Wx.point = Ha, Km = null
	}

	function $a(t, n) {
		if (Km) {
			var e = t - Gm;
			Vx.add(Sx(e) > 180 ? e + (e > 0 ? 360 : -360) : e)
		} else Jm = t, Qm = n;
		Hx.point(t, n), Xa(t, n)
	}
	...
	function Ga() {
		$a(Jm, Qm), Hx.lineEnd(), Sx(Vx) > mx && (Vm = -($m = 180)), nx[0] = Vm, nx[1] = $m, Km = null
	}
	...
	function tc(t, n) {
		t *= kx, n *= kx;
		var e = Cx(n);
		nc(e * Cx(t), e * Rx(t), Rx(n))
	}

	function nc(t, n, e) {
		++ex, ix += (t - ix) / ex, ox += (n - ox) / ex, ux += (e - ux) / ex
	}
	...
	function rc(t, n) {
		t *= kx, n *= kx;
		var e = Cx(n);
		vx = e * Cx(t), _x = e * Rx(t), yx = Rx(n), Zx.point = ic, nc(vx, _x, yx)
	}
	...
	function ic(t, n) {
		...
		var e = Cx(n),
			...
			i = e * Rx(t),
			o = Rx(n),
			u = Ex(Dx((u = _x * o - yx * i) * u + (u = yx * r - vx * o) * u + (u = vx * i - _x * r) * u), vx * r + _x * i + yx * o);
		rx += u, ax += u * (vx + (vx = r)), cx += u * (_x + (_x = i)), sx += u * (yx + (yx = o)), nc(vx, _x, yx)
	}
	...
	function ac() {
		sc(px, dx), Zx.point = tc
	}

	function cc(t, n) {
		px = t, dx = n, t *= kx, n *= kx, Zx.point = sc;
		var e = Cx(n);
		vx = e * Cx(t), _x = e * Rx(t), yx = Rx(n), nc(vx, _x, yx)
	}
	...
	function sc(t, n) {
		...
		var e = Cx(n),
			...
			l = s && -ka(f) / s,
			h = Ex(s, f);
		fx += l * u, lx += l * a, hx += l * c, rx += h, ax += h * (vx + (vx = r)), cx += h * (_x + (_x = i)), sx += h * (yx + (yx = o)), nc(vx, _x, yx)
	}

	function fc(t, n) {
		return [t > bx ? t - Tx : t < -bx ? t + Tx : t, n]
	}

	function lc(t, n, e) {
		return (t %= Tx) ? n || e ? Qx(pc(t), dc(n, e)) : pc(t) : n || e ? dc(n, e) : fc
	}

	function hc(t) {
		return function (n, e) {
			return n += t, [n > bx ? n - Tx : n < -bx ? n + Tx : n, e]
		}
	}
	...
	function dc(t, n) {
		function e(t, n) {
			var e = Cx(n),
				...
				s = Rx(n),
				f = s * r + a * i;
			return [Ex(c * o - f * u, a * r - s * i), Sa(f * o + c * u)]
		}
		var r = Cx(t),
			i = Rx(t),
			o = Cx(n),
		...
		return e.invert = function (t, n) {
			var e = Cx(n),
				...
				s = Rx(n),
				f = s * o - c * u;
			return [Ex(c * o + s * u, a * r + f * i), Sa(f * r - a * i)]
		}, e
	}
	...
	function vc(t, n, e, r, i, o) {
		if (e) {
			var u = Cx(n),
				a = Rx(n),
				c = r * e;
			null == i ? (i = n + r * Tx, o = n - c / 2) : (i = _c(u, i), o = _c(u, o), (r > 0 ? i < o : i > o) && (i += r * Tx));
			for (var s, f = i; r > 0 ? f > o : f < o; f -= c) s = Da([u, -a * Cx(f), -a * Rx(f)]), t.point(s[0], s[1])
		}
	}
	...
	function mc(t, n, e, r) {
		...
		function u(r, i) {
			return Sx(r[0] - t) < mx ? i > 0 ? 0 : 3 : Sx(r[0] - e) < mx ? i > 0 ? 2 : 1 : Sx(r[1] - n) < mx ? i > 0 ? 1 : 0 : i > 0 ? 3 : 2
		}
		...
		return function (u) {
			...
			function l() {
				var t = s(),
					n = N && t,
					e = (v = Ws(v)).length;
				(n || e) && (u.polygonStart(), n && (u.lineStart(), o(null, null, 1, u), u.lineEnd()), e && vb(v, a, t, o, u), u.polygonEnd()), k = u, v = _ = y = null
			}
			...
			function d(o, u) {
				...
				if (_ && y.push([o, u]), T) g = o, m = u, x = a, T = !1, a && (k.lineStart(), k.point(o, u));
					...
					var c = [b = Math.max(yb, Math.min(_b, b)), w = Math.max(yb, Math.min(_b, w))],
						s = [o = Math.max(yb, Math.min(_b, o)), u = Math.max(yb, Math.min(_b, u))];
					pb(c, s, t, n, e, r) ? (M || (k.lineStart(), k.point(c[0], c[1])), k.point(s[0], s[1]), a || k.lineEnd(), N = !1) : a && (k.lineStart(), k.point(o, u), N = !1)
				}
				b = o, w = u, M = a
			}
	...
	function xc() {
		xb.point = wc, xb.lineEnd = bc
	}

	function bc() {
		xb.point = xb.lineEnd = Ea
	}

	function wc(t, n) {
		t *= kx, n *= kx, Kx = t, tb = Rx(n), nb = Cx(n), xb.point = Mc
	}
	...
	function Mc(t, n) {
		...
		var e = Rx(n),
			...
			c = nb * e - tb * r * o,
			s = tb * e + nb * r * o;
		mb.add(Ex(Dx(a * a + c * c), s)), Kx = t, tb = e, nb = r
	}

	function Tc(t, n, e) {
		var r = Ls(t, n - mx, e).concat(n);
		return function (t) {
	...
	function Sc(t, n) {
		Cb.point = Ac, eb = ib = t, rb = ob = n
	}

	function Ac(t, n) {
		Eb.add(ob * t - ib * n), ib = t, ob = n
	}
	...
	function Cc(t, n) {
		t < zb && (zb = t), t > qb && (qb = t), n < Pb && (Pb = n), n > Lb && (Lb = n)
	}
	...
	function Lc(t, n) {
		var e = t - cb,
			r = n - sb,
			i = Dx(e * e + r * r);
		Fb += i * (cb + t) / 2, Ib += i * (sb + n) / 2, Yb += i, zc(cb = t, sb = n)
	}
	...
	function Oc(t, n) {
		Xb.point = Fc, zc(ub = cb = t, ab = sb = n)
	}
	...
	function Fc(t, n) {
		var e = t - cb,
			r = n - sb,
			i = Dx(e * e + r * r);
		Fb += i * (cb + t) / 2, Ib += i * (sb + n) / 2, Yb += i, i = sb * t - cb * n, Bb += i * (cb + t), jb += i * (sb + n), Hb += 3 * i, zc(cb = t, sb = n)
	}
	...
	function Hc(t, n) {
		return ((t = t.x)[0] < 0 ? t[1] - wx - mx : wx - t[1]) - ((n = n.x)[0] < 0 ? n[1] - wx - mx : wx - n[1])
	}
	...
	function Xc(t) {
		...
		return {
			...
			point: function (o, u) {
				var a = o > 0 ? bx : -bx,
					c = Sx(o - e);
				Sx(c - bx) < mx ? (t.point(e, r = (r + u) / 2 > 0 ? wx : -wx), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), t.point(o, r), n = 0) : i !== a && c >= bx && (Sx(e - i) < mx && (e -= i * mx), Sx(o - a) < mx && (o -= a * mx), r = Vc(e, r, o, u), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), n = 0), t.point(e = o, r = u), i = a
			},
			lineEnd: function () {
				t.lineEnd(), e = r = NaN
			},
	...
	function Vc(t, n, e, r) {
		var i, o, u = Rx(t - e);
		return Sx(u) > mx ? Ax((Rx(n) * (o = Cx(r)) * Rx(e) - Rx(r) * (i = Cx(n)) * Rx(t)) / (i * o * u)) : (n + r) / 2
	}

	function Wc(t, n, e, r) {
		var i;
		if (null == t) i = e * wx, r.point(-bx, i), r.point(0, i), r.point(bx, i), r.point(bx, 0), r.point(bx, -i), r.point(0, -i), r.point(-bx, -i), r.point(-bx, 0), r.point(-bx, i);
		else if (Sx(t[0] - n[0]) > mx) {
			var o = t[0] < n[0] ? bx : -bx;
	...
	function Gc(t, n, e) {
		...
		t.scale(150).translate([0, 0]), null != o && t.clipExtent(null), Yx(e, t.stream(Rb));
		var u = Rb.result(),
		...
		function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
			...
			if (m > 4 * n && v--) {
				var x = u + h,
					...
					M = Dx(x * x + b * b + w * w),
					T = Sa(w /= M),
					N = Sx(Sx(w) - 1) < mx || Sx(o - l) < mx ? (o + l) / 2 : Ex(b, x),
					k = t(N, T),
					S = k[0],
					A = k[1],
					E = S - r,
					C = A - i,
					z = g * E - y * C;
				(z * z / m > n || Sx((y * E + g * C) / m - .5) > .3 || u * h + a * p + c * d < tw) && (e(r, i, o, u, a, c, S, A, N, x /= M, b /= M, w, v, _), _.point(S, A), e(S, A, N, x, b, w, s, f, l, h, p, d, v, _))
			}
		}
		return function (n) {
			function r(e, r) {
			...
			function o(r, i) {
				var o = Oa([r, i]),
					u = t(r, i);
				e(y, g, _, m, x, b, y = u[0], g = u[1], _ = r, m = o[0], x = o[1], b = o[2], Kb, n), n.point(y, g)
			}
			...
			function s() {
				e(y, g, _, m, x, b, l, h, f, p, d, v, Kb, n), w.lineEnd = u, u()
			}
	...
	function es(t) {
		function n(t) {
			return t = f(t[0] * kx, t[1] * kx), [t[0] * _ + a, c - t[1] * _]
		}

		function e(t) {
			return t = f.invert((t[0] - a) / _, (c - t[1]) / _), t && [t[0] * Nx, t[1] * Nx]
		}
		...
		return n.stream = function (t) {
				return d && v === t ? d : d = ew(N(s, E(S(v = t))))
			}, n.clipAngle = function (t) {
				return arguments.length ? (N = +t ? Jb(T = t * kx, 6 * kx) : (T = null, Gb), o()) : T * Nx
			}, n.clipExtent = function (t) {
				return arguments.length ? (S = null == t ? (k = l = h = p = null, Sb) : mc(k = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]), o()) : null == k ? null : [
					[k, l],
					[h, p]
				]
			}, n.scale = function (t) {
				...
				return arguments.length ? (m = t[0] % 360 * kx, x = t[1] % 360 * kx, i()) : [m * Nx, x * Nx]
			}, n.rotate = function (t) {
				return arguments.length ? (b = t[0] % 360 * kx, w = t[1] % 360 * kx, M = t.length > 2 ? t[2] % 360 * kx : 0, i()) : [b * Nx, w * Nx, M * Nx]
			}, n.precision = function (t) {
				return arguments.length ? (E = nw(r, A = t * t), o()) : Dx(A)
			}, n.fitExtent = Qc(n), n.fitSize = Jc(n),
			function () {
	...
	function rs(t) {
		...
		return i.parallels = function (t) {
			return arguments.length ? r(n = t[0] * kx, e = t[1] * kx) : [n * Nx, e * Nx]
		}, i
	}

	function is(t, n) {
		function e(t, n) {
			var e = Dx(o - 2 * i * Rx(n)) / i;
			return [e * Rx(t *= i), u - e * Cx(t)]
		}
		var r = Rx(t),
			i = (r + Rx(n)) / 2,
			o = 1 + r * (2 * i - r),
		...
		return e.invert = function (t, n) {
			var e = u - n;
			return [Ex(t, e) / i, Sa((o - (t * t + e * e) * i * i) / (2 * i))]
		}, e
	}
	...
	function as(t) {
		return function (n, e) {
			var r = Dx(n * n + e * e),
				...
				o = Rx(i),
				u = Cx(i);
			return [Ex(n * o, r * u), Sa(r && e * o / r)]
		}
	}

	function cs(t, n) {
		return [t, qx(Ox((wx + n) / 2))]
	}
	...
	function ls(t, n) {
		function e(t, n) {
			o > 0 ? n < -wx + mx && (n = -wx + mx) : n > wx - mx && (n = wx - mx);
			var e = o / Lx(fs(n), i);
			return [e * Rx(i * t), o - e * Cx(i * t)]
		}
		var r = Cx(t),
			i = t === n ? Rx(t) : qx(r / Cx(n)) / qx(fs(n) / fs(t)),
			o = r * Lx(fs(t), i) / i;
		return i ? (e.invert = function (t, n) {
			var e = o - n,
				r = Ux(i) * Dx(t * t + e * e);
			return [Ex(t, e) / i, 2 * Ax(Lx(o / r, 1 / i)) - wx]
		}, e) : cs
	}
	...
	function ps(t, n) {
		function e(t, n) {
			var e = o - n,
				r = i * t;
			return [e * Rx(r), o - e * Cx(r)]
		}
		var r = Cx(t),
			i = t === n ? Rx(t) : (r - Cx(n)) / (n - t),
			o = r / i + t;
		return Sx(i) < mx ? hs : (e.invert = function (t, n) {
			var e = o - n;
			return [Ex(t, e) / i, o - Ux(i) * Dx(t * t + e * e)]
		}, e)
	}
	...
	function ds(t, n) {
		var e = Cx(n),
			r = Cx(t) * e;
		return [e * Rx(t) / r, Rx(n) / r]
	}

	function vs(t, n) {
		return [Cx(n) * Rx(t), Rx(n)]
	}
	...
	var gs = "4.2.3",
		...
		ks = function (t, n) {
			var e, r, i = t.length,
				...
				c = 0;
			if (null == n)
				for (; ++a < i;) isNaN(e = Ns(t[a])) || (r = e - o, o += r / ++c, u += r * (e - o));
			else
				for (; ++a < i;) isNaN(e = Ns(n(t[a], a, t))) || (r = e - o, o += r / ++c, u += r * (e - o));
			if (c > 1) return u / (c - 1)
		},
		Ss = function (t, n) {
			var e = ks(t, n);
		...
		Xs = function (t, n) {
			var e, r = 0,
				...
				u = i;
			if (null == n)
				for (; ++o < i;) isNaN(e = Ns(t[o])) ? --u : r += e;
			else
				for (; ++o < i;) isNaN(e = Ns(n(t[o], o, t))) ? --u : r += e;
			if (u) return r / u
		},
		Vs = function (t, n) {
			var e, r = [],
				...
				o = -1;
			if (null == n)
				for (; ++o < i;) isNaN(e = Ns(t[o])) || r.push(e);
			else
				for (; ++o < i;) isNaN(e = Ns(n(t[o], o, t))) || r.push(e);
	...
	i.prototype = o.prototype = {
		...
		entries: function () {
			var t = [];
			for (var n in this) n[0] === ef && t.push({
				key: n.slice(1),
				value: this[n]
			});
			return t
	...
	var Jf = function (t) {
		...
		el = function (t, n, e) {
			var r, i, o, u, a, c, s, f = this._x0,
				...
				d = [],
				v = this._root;
			for (v && d.push(new nl(v, f, l, h, p)), null == e ? e = 1 / 0 : (f = t - e, l = n - e, h = t + e, p = n + e, e *= e); c = d.pop();)
		...
		gl = function () {
			function t() {
				var t, s, f = +n.apply(this, arguments),
					...
					h = o.apply(this, arguments) - _l,
					p = u.apply(this, arguments) - _l,
					d = Math.abs(p - h),
					v = p > h;
				if (c || (c = t = L()), l < f && (s = l, l = f, f = s), l > dl)
					if (d > yl - dl) c.moveTo(l * Math.cos(h), l * Math.sin(h)), c.arc(0, 0, l, h, p, !v), f > dl && (c.moveTo(f * Math.cos(p), f * Math.sin(p)), c.arc(0, 0, f, p, h, v));
					else {
						var _, y, g = h,
							m = p,
							x = h,
							...
							N = T > dl && (i ? +i.apply(this, arguments) : Math.sqrt(f * f + l * l)),
		...
		Tl = function () {
			function t(t) {
				var a, c, s, f, l, h = t.length,
					...
					y = Math.min(yl, Math.max(-yl, o.apply(this, arguments) - _)),
	...
	var Zh, Gh, Jh, Qh, Kh = function (t) {
		...
		sp = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
		fp = new RegExp(sp.source, "g"),
		lp = function (t, n) {
			var e, r, i, o = sp.lastIndex = fp.lastIndex = 0,
				u = -1,
				a = [],
				c = [];
			for (t += "", n += "";
				(e = sp.exec(t)) && (r = fp.exec(n));)(i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i), (e = e[0]) === (r = r[0]) ? a[u] ? a[u] += r : a[++u] = r : (a[++u] = null, c.push({
				i: u,
				x: ap(e, r)
			})), o = fp.lastIndex;
	...
	var Pp, qp, Lp = function (t) {
		...
		Qp = Jp("text/csv", Up),
		Kp = Jp("text/tab-separated-values", Yp),
		td = 0,
		nd = 0,
		ed = 0,
		rd = 1e3,
		...
		od = 0,
		ud = 0,
		ad = "object" == typeof performance && performance.now ? performance : Date,
		cd = "function" == typeof requestAnimationFrame ? requestAnimationFrame : function (t) {
			setTimeout(t, 17)
		};
	...
	var kv, Sv = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"],
		Av = function (t) {
			function n(t) {
				function n(t) {
					var n, i, c, g = d,
					...
					if ("c" === p) m = _(t) + m, t = "";
						...
						if (g = (x ? "(" === a ? a : "-" : "-" === a || "(" === a ? "" : a) + g, m = m + ("s" === p ? Sv[8 + vv / 3] : "") + (x && "(" === a ? ")" : ""), y)
	...
	var A_ = function (t, n, e) {
		...
		z_ = function (t) {
			var n = E_();
			return n.changedTouches && (n = n.changedTouches[0]), C_(t, n)
		},
		P_ = function (t) {
		...
		O_ = function () {
			return new zi(this._enter || this._groups.map(D_), this._parents)
		};
	$r.prototype = {
		constructor: $r,
	...
	var F_ = function (t) {
		...
		B_ = function () {
			return new zi(this._exit || this._groups.map(D_), this._parents)
		},
		j_ = function (t) {
		...
		ty = function (t, n, e) {
			var r;
			return arguments.length > 1 ? this.each((null == n ? ii : "function" == typeof n ? ui : oi)(t, n, null == e ? "" : e)) : K_(r = this.node()).getComputedStyle(r, null).getPropertyValue(t)
		},
		ny = function (t, n) {
	...
	var ey = function (t, n) {
		...
		cy = function (t, n) {
			var e = "function" == typeof t ? t : b_(t),
				r = null == n ? ki : "function" == typeof n ? n : P_(n);
			return this.select(function () {
	...
	var py = function (t) {
		...
		dy = function (t) {
			return "string" == typeof t ? new zi([document.querySelectorAll(t)], [document.documentElement]) : new zi([null == t ? [] : t], hy)
		},
		vy = function (t, n, e) {
			arguments.length < 3 && (e = n, n = E_().changedTouches);
			for (var r, i = 0, o = n ? n.length : 0; i < o; ++i)
				if ((r = n[i]).identifier === e) return C_(t, r);
			return null
		},
		_y = function (t, n) {
			null == n && (n = E_().touches);
			for (var e = 0, r = n ? n.length : 0, i = new Array(r); e < r; ++e) i[e] = C_(t, n[e]);
			return i
		},
		yy = Pn("start", "end", "interrupt"),
		gy = [],
		my = 0,
		xy = 1,
		by = 2,
		...
		Sy = function (t, n) {
			...
			if (o) {
				n = null == n ? null : n + "";
				for (i in o)(e = o[i]).name === n ? (r = e.state === wy, e.state = Ny, e.timer.stop(), r && e.on.call("interrupt", t, t.__data__, e.index, e.group), delete o[i]) : u = !1;
		...
		Iy = function (t) {
			...
			for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
				for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)(a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, ky(l[h], n, e, h, l, Ri(a, e)));
		...
		Yy = function (t) {
			...
			for (var r = this._groups, i = r.length, o = [], u = [], a = 0; a < i; ++a)
				for (var c, s = r[a], f = s.length, l = 0; l < f; ++l)
					if (c = s[l]) {
						for (var h, p = t.call(c, c.__data__, l, s), d = Ri(c, e), v = 0, _ = p.length; v < _; ++v)(h = p[v]) && ky(h, n, e, v, p, d);
						o.push(p), u.push(c)
					}
			return new so(o, u, n, e)
		},
		By = Pi.prototype.constructor,
		jy = function () {
			return new By(this._groups, this._parents)
		},
		Hy = function (t, n, e) {
			var r = "transform" == (t += "") ? yp : Cy;
	...
	var Gy = {
		...
		Jy = function (t) {
			var n, e;
			t instanceof so ? (n = t._id, t = t._name) : (n = lo(), (e = Gy).time = jn(), t = null == t ? null : t + "");
			for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
				for (var u, a = r[o], c = a.length, s = 0; s < c; ++s)(u = a[s]) && ky(u, t, n, s, a, e || ho(u, n));
			return new so(r, this._parents, t, n)
		};
	Pi.prototype.interrupt = Ay, Pi.prototype.transition = Jy;
	var Qy = [null],
		Ky = function (t, n) {
			...
			if (i) {
				n = null == n ? null : n + "";
				for (r in i)
					if ((e = i[r]).state > xy && e.name === n) return new so([
						[t]
					], Qy, n, +r)
			}
			return null
	...
	var gg = function (t) {
		...
		wg = function () {
			...
			return t.radius = function (e) {
				...
				return arguments.length ? (i = "function" == typeof n ? n : bg(+n), t) : i
			}, t
		},
		Mg = function (t) {
			t.x0 = Math.round(t.x0), t.y0 = Math.round(t.y0), t.x1 = Math.round(t.x1), t.y1 = Math.round(t.y1)
		},
		Tg = function (t, n, e, r, i) {
			for (var o, u = t.children, a = -1, c = u.length, s = t.value && (r - n) / t.value; ++a < c;) o = u[a], o.y0 = e, o.y1 = i, o.x0 = n, o.x1 = n += o.value * s
		},
		Ng = function () {
			function t(t) {
				var u = t.height + 1;
				return t.x0 = t.y0 = i, t.x1 = e, t.y1 = r / u, t.eachBefore(n(r, u)), o && t.eachBefore(Mg), t
			}

			function n(t, n) {
				return function (e) {
					e.children && Tg(e, e.x0, t * (e.depth + 1) / n, e.x1, t * (e.depth + 2) / n);
					var r = e.x0,
						o = e.y0,
						u = e.x1 - i,
						a = e.y1 - i;
		...
		Eg = function () {
			function t(t) {
				var r, i, o, u, a, c, s, f = t.length,
					l = new Array(f),
					h = {};
				for (i = 0; i < f; ++i) r = t[i], a = l[i] = new Uo(r), null != (c = n(r, i, t)) && (c += "") && (s = kg + (a.id = c), h[s] = s in h ? Ag : a);
				for (i = 0; i < f; ++i)
					if (a = l[i], c = e(t[i], i, t), null != c && (c += "")) {
						if (u = h[kg + c], !u) throw new Error("missing: " + c);
						if (u === Ag) throw new Error("ambiguous: " + c);
				...
				if (o.parent = Sg, o.eachBefore(function (t) {
	...
	var Cg = function () {
		...
		Lg = function () {
			function t(t) {
				return t.x0 = t.y0 = 0, t.x1 = i, t.y1 = o, t.eachBefore(n), u = [0], r && t.eachBefore(Mg), t
			}
			...
			return t.round = function (n) {
				...
				return arguments.length ? (a = "function" == typeof n ? n : bg(+n), t) : a
				...
				return arguments.length ? (c = "function" == typeof n ? n : bg(+n), t) : c
			}, t.paddingRight = function (n) {
				return arguments.length ? (s = "function" == typeof n ? n : bg(+n), t) : s
			}, t.paddingBottom = function (n) {
				return arguments.length ? (f = "function" == typeof n ? n : bg(+n), t) : f
			}, t.paddingLeft = function (n) {
				return arguments.length ? (l = "function" == typeof n ? n : bg(+n), t) : l
			}, t
		},
			...
			function e(t, e, r, i, o) {
				if ((u = t._squarify) && u.ratio === n)
					for (var u, a, c, s, f, l = -1, h = u.length, p = t.value; ++l < h;) {
						...
						a.dice ? Tg(a, e, r, i, r += (o - r) * a.value / p) : zg(a, e, r, e += (i - e) * a.value / p, o), p -= a.value
		...
		Yg = function (t) {
					...
					var a = t.data,
						...
						if (a.index > n) {
							var v = s - a.x - a.vx,
								_ = f - a.y - a.vy,
								y = v * v + _ * _;
							y < d * d && (0 === v && (v = Ig(), y += v * v), 0 === _ && (_ = Ig(), y += _ * _), y = (d - (y = Math.sqrt(y))) / y * o, c.vx += (v *= y) * (d = (p *= p) / (h + p)), c.vy += (_ *= y) * d, a.vx -= v * (d = 1 - d), a.vy -= _ * d)
						}
					}
				}
				for (var n, a, c, s, f, l, h, p = r.length, d = 0; d < u; ++d)
					for (a = I(r, hu, pu).visitAfter(e), n = 0; n < p; ++n) c = r[n], l = i[n], h = l * l, s = c.x + c.vx, f = c.y + c.vy, a.visit(t)
			}
			...
			var r, i, o = 1,
				u = 1;
			return "function" != typeof t && (t = Fg(null == t ? 1 : +t)), n.initialize = function (n) {
				var e, o = (r = n).length;
				...
				return arguments.length ? (t = "function" == typeof e ? e : Fg(+e), n) : t
			}, n
		},
		Bg = function (t) {
			function n(t) {
			...
			function e(n) {
				for (var e = 0, r = t.length; e < v; ++e)
					for (var i, o, u, s, f, h, p, d = 0; d < r; ++d) i = t[d], o = i.source, u = i.target, s = u.x + u.vx - o.x - o.vx || Ig(), f = u.y + u.vy - o.y - o.vy || Ig(), h = Math.sqrt(s * s + f * f), h = (h - c[d]) / h * n * a[d], s *= h, f *= h, u.vx -= s * (p = l[d]), u.vy -= f * p, o.vx += s * (p = 1 - p), o.vy += f * p
			}
			...
			return null == t && (t = []), e.initialize = function (t) {
				...
				return arguments.length ? (p = "function" == typeof t ? t : Fg(+t), i(), e) : p
			}, e.distance = function (t) {
				return arguments.length ? (d = "function" == typeof t ? t : Fg(+t), u(), e) : d
			}, e
		},
		jg = 10,
		Hg = Math.PI * (3 - Math.sqrt(5)),
		Xg = function (t) {
			function n() {
		...
		Vg = function () {
			...
			function r(t, n, e, r) {
				...
				var i = t.x - o.x,
					...
					h = r - n,
					p = i * i + c * c;
				if (h * h / l < p) return p < f && (0 === i && (i = Ig(), p += i * i), 0 === c && (c = Ig(), p += c * c), p < s && (p = Math.sqrt(s * p)), o.vx += i * t.value * u / p, o.vy += c * t.value * u / p), !0;
				if (!(t.length || p >= f)) {
					(t.data !== o || t.next) && (0 === i && (i = Ig(), p += i * i), 0 === c && (c = Ig(), p += c * c), p < s && (p = Math.sqrt(s * p)));
			...
			return t.initialize = function (t) {
				...
				return arguments.length ? (c = "function" == typeof e ? e : Fg(+e), n(), t) : c
		...
		Wg = function (t) {
			...
			var r, i, o, u = Fg(.1);
			return "function" != typeof t && (t = Fg(null == t ? 0 : +t)), n.initialize = function (t) {
				r = t, e()
			}, n.strength = function (t) {
				return arguments.length ? (u = "function" == typeof t ? t : Fg(+t), e(), n) : u
			}, n.x = function (r) {
				return arguments.length ? (t = "function" == typeof r ? r : Fg(+r), e(), n) : t
			}, n
		},
		$g = function (t) {
			function n(t) {
		...
		Gg = function (t) {
			var n = t.document.documentElement,
				e = py(t).on("dragstart.drag", Zg, !0);
			"onselectstart" in n ? e.on("selectstart.drag", Zg, !0) : (n.__noselect = n.style.MozUserSelect, n.style.MozUserSelect = "none")
		},
		Jg = function (t) {
			return function () {
				return t
	...
	var Qg = function () {
			...
			function e() {
				if (!f && l.apply(this, arguments)) {
					var n = c("mouse", h.apply(this, arguments), z_, this, arguments);
					n && (py(t.event.view).on("mousemove.drag", r, !0).on("mouseup.drag", i, !0), Gg(t.event.view), yu(), s = !1, n("start"))
				}
			}
			...
			function i() {
				py(t.event.view).on("mousemove.drag mouseup.drag", null), gu(t.event.view, s), Zg(), d.mouse("end")
			}
			...
			function o() {
				if (l.apply(this, arguments)) {
					var n, e, r = t.event.changedTouches,
						...
						o = r.length;
					for (n = 0; n < o; ++n)(e = c(r[n].identifier, i, vy, this, arguments)) && (yu(), e("start"))
				}
			}
			...
			function u() {
				var n, e, r = t.event.changedTouches,
					i = r.length;
				for (n = 0; n < i; ++n)(e = d[r[n].identifier]) && (Zg(), e("drag"))
			}
			...
			return n.filter = function (t) {
				return arguments.length ? (l = "function" == typeof t ? t : Jg(!!t), n) : l
			}, n.container = function (t) {
				return arguments.length ? (h = "function" == typeof t ? t : Jg(t), n) : h
			}, n.subject = function (t) {
				return arguments.length ? (p = "function" == typeof t ? t : Jg(t), n) : p
			}, n.on = function () {
	...
	var sm = function () {
			function t(t) {
				return new ta(t.map(function (r, i) {
					var o = [Math.round(n(r, i, t) / am) * am, Math.round(e(r, i, t) / am) * am];
			...
			return t.polygons = function (n) {
				...
				return arguments.length ? (n = "function" == typeof e ? e : Kg(+e), t) : n
			}, t.y = function (n) {
				return arguments.length ? (e = "function" == typeof n ? n : Kg(+n), t) : e
			}, t.extent = function (n) {
		...
		pm = function () {
			...
			function s() {
				...
				if (y.apply(this, arguments)) {
					...
					if (o.wheel) o.mouse[0][0] === s[0] && o.mouse[0][1] === s[1] || (o.mouse[1] = u.invert(o.mouse[0] = s)), clearTimeout(o.wheel);
						...
						if (u.k === c) return;
						o.mouse = [s, u.invert(s)], Sy(this), o.start()
					}
					hm(), o.wheel = setTimeout(n, E), o.zoom("mouse", i(r(e(u, c), o.mouse[0], o.mouse[1]), o.extent))
				}
			}

			function f() {
				function n() {
					hm(), o.moved = !0, o.zoom("mouse", i(r(o.that.__zoom, o.mouse[0] = z_(o.that), o.mouse[1]), o.extent))
				}

				function e() {
					u.on("mousemove.zoom mouseup.zoom", null), gu(t.event.view, o.moved), hm(), o.end()
				}
				if (!_ && y.apply(this, arguments)) {
					var o = a(this, arguments),
						u = py(t.event.view).on("mousemove.zoom", n, !0).on("mouseup.zoom", e, !0),
						c = z_(this);
					Gg(t.event.view), ia(), o.mouse = [c, this.__zoom.invert(c)], Sy(this), o.start()
				}
			}
			...
			function l() {
				if (y.apply(this, arguments)) {
					...
					hm(), N > 0 ? py(this).transition().duration(N).call(u, f, a) : py(this).call(n.transform, f)
				}
			}
			...
			function h() {
				if (y.apply(this, arguments)) {
					var n, e, r, i = a(this, arguments),
						...
						u = o.length;
					for (ia(), n = 0; n < u; ++n) e = o[n], r = vy(this, o, e.identifier), r = [r, this.__zoom.invert(r), e.identifier], i.touch0 ? i.touch1 || (i.touch1 = r) : i.touch0 = r;
			...
			function p() {
				var n, o, u, c, s = a(this, arguments),
					...
					l = f.length;
				for (hm(), v && (v = clearTimeout(v)), n = 0; n < l; ++n) o = f[n], u = vy(this, f, o.identifier), s.touch0 && s.touch0[2] === o.identifier ? s.touch0[0] = u : s.touch1 && s.touch1[2] === o.identifier && (s.touch1[0] = u);
			...
			return n.transform = function (t, n) {
				...
				return arguments.length ? (y = "function" == typeof t ? t : fm(!!t), n) : y
			}, n.extent = function (t) {
				return arguments.length ? (g = "function" == typeof t ? t : fm([
					[+t[0][0], +t[0][1]],
					[+t[1][0], +t[1][1]]
				]), n) : g
		...
		Um = function () {
			function t(t) {
				...
				for (e && p.sort(function (t, n) {
					...
					}), o = Rm(0, Lm - n * l) / o, c = o ? n : Lm / l, u = 0, s = -1; ++s < l;) {
					for (a = u, f = -1; ++f < l;) {
						var g = p[s],
							m = d[g][f],
							x = t[g][m],
			...
			return t.padAngle = function (e) {
				return arguments.length ? (n = Rm(0, e), t) : n
		...
		Fm = function () {
			function t() {
				var t, a = Dm.call(arguments),
					...
					_ = i.apply(this, a) - qm,
					y = o.apply(this, a) - qm;
				if (u || (u = t = L()), u.moveTo(p, d), u.arc(0, 0, f, l, h), l === _ && h === y || (u.quadraticCurveTo(0, 0, v * Cm(_), v * zm(_)), u.arc(0, 0, v, _, y)), u.quadraticCurveTo(0, 0, p, d), u.closePath(), t) return u = null, t + "" || null
			}
			var n = ma,
				e = xa,
				r = ba,
			...
			return t.radius = function (n) {
				return arguments.length ? (r = "function" == typeof n ? n : Om(+n), t) : r
			}, t.startAngle = function (n) {
				return arguments.length ? (i = "function" == typeof n ? n : Om(+n), t) : i
			}, t.endAngle = function (n) {
				return arguments.length ? (o = "function" == typeof n ? n : Om(+n), t) : o
			}, t.source = function (e) {
				return arguments.length ? (n = e, t) : n
			}, t.target = function (n) {
				return arguments.length ? (e = n, t) : e
	...
	Ta.prototype = {
		...
		add: function (t) {
			Na(gx, t, this.t), Na(this, gx.s, this.s), this.s ? this.t += gx.t : this.s = gx.t
		},
		valueOf: function () {
			return this.s
		}
	};
	var Ym, Bm, jm, Hm, Xm, Vm, Wm, $m, Zm, Gm, Jm, Qm, Km, tx, nx, ex, rx, ix, ox, ux, ax, cx, sx, fx, lx, hx, px, dx, vx, _x, yx, gx = new Ta,
		mx = 1e-6,
		xx = 1e-12,
		bx = Math.PI,
		wx = bx / 2,
		...
		Yx = function (t, n) {
			t && Fx.hasOwnProperty(t.type) ? Fx[t.type](t, n) : Ca(t, n)
		},
		Bx = Im(),
		jx = Im(),
		Hx = {
			...
			lineEnd: Ea,
			polygonStart: function () {
				Bx.reset(), Hx.lineStart = qa, Hx.lineEnd = La
			},
			polygonEnd: function () {
				var t = +Bx;
				jx.add(t < 0 ? Tx + t : t), this.lineStart = this.lineEnd = this.point = Ea
			},
			sphere: function () {
				jx.add(Tx)
			}
		...
		Wx = {
			...
			lineEnd: Wa,
			polygonStart: function () {
				Wx.point = $a, Wx.lineStart = Za, Wx.lineEnd = Ga, Vx.reset(), Hx.polygonStart()
			},
			polygonEnd: function () {
				Hx.polygonEnd(), Wx.point = Ha, Wx.lineStart = Va, Wx.lineEnd = Wa, Bx < 0 ? (Vm = -($m = 180), Wm = -(Zm = 90)) : Vx > mx ? Zm = 90 : Vx < -mx && (Wm = -90), nx[0] = Vm, nx[1] = $m
			}
		},
		$x = function (t) {
			var n, e, r, i, o, u, a;
			if (Zm = $m = -(Vm = Wm = 1 / 0), tx = [], Yx(t, Wx), e = tx.length) {
				for (tx.sort(Qa), n = 1, r = tx[0], o = [r]; n < e; ++n) i = tx[n], Ka(r, i[0]) || Ka(r, i[1]) ? (Ja(r[0], i[1]) > Ja(r[0], r[1]) && (r[1] = i[1]), Ja(i[0], r[1]) > Ja(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
				for (u = -(1 / 0), e = o.length - 1, n = 0, r = o[e]; n <= e; r = i, ++n) i = o[n], (a = Ja(r[1], i[0])) > u && (u = a, Vm = i[0], $m = r[1])
			}
			return tx = nx = null, Vm === 1 / 0 || Wm === 1 / 0 ? [
				[NaN, NaN],
				[NaN, NaN]
			] : [
				[Vm, Wm],
		...
		Zx = {
			...
			lineEnd: oc,
			polygonStart: function () {
				Zx.lineStart = uc, Zx.lineEnd = ac
			},
			polygonEnd: function () {
				Zx.lineStart = ec, Zx.lineEnd = oc
			}
		},
		Gx = function (t) {
			ex = rx = ix = ox = ux = ax = cx = sx = fx = lx = hx = 0, Yx(t, Zx);
			var n = fx,
				e = lx,
				r = hx,
				i = n * n + e * e + r * r;
			return i < xx && (n = ax, e = cx, r = sx, rx < mx && (n = ix, e = ox, r = ux), i = n * n + e * e + r * r, i < xx) ? [NaN, NaN] : [Ex(e, n) * Nx, Sa(r / Dx(i)) * Nx]
		},
		Jx = function (t) {
			return function () {
				return t
	...
	fc.invert = fc;
	var Kx, tb, nb, eb, rb, ib, ob, ub, ab, cb, sb, fb = function (t) {
			function n(n) {
				return n = t(n[0] * kx, n[1] * kx), n[0] *= Nx, n[1] *= Nx, n
			}
			return t = lc(t[0] * kx, t[1] * kx, t.length > 2 ? t[2] * kx : 0), n.invert = function (n) {
				return n = t.invert(n[0] * kx, n[1] * kx), n[0] *= Nx, n[1] *= Nx, n
			}, n
		},
		lb = function () {
			function t(t, n) {
				e.push(t = r(t, n)), t[0] *= Nx, t[1] *= Nx
			}

			function n() {
				var t = i.apply(this, arguments),
					n = o.apply(this, arguments) * kx,
					c = u.apply(this, arguments) * kx;
				return e = [], r = lc(-t[0] * kx, -t[1] * kx, 0).invert, vc(a, n, c, 1), t = {
					type: "Polygon",
					coordinates: [e]
				}, e = r = null, t
			}
			...
			return n.center = function (t) {
				return arguments.length ? (i = "function" == typeof t ? t : Jx([+t[0], +t[1]]), n) : i
			}, n.radius = function (t) {
				return arguments.length ? (o = "function" == typeof t ? t : Jx(+t), n) : o
			}, n.precision = function (t) {
				return arguments.length ? (u = "function" == typeof t ? t : Jx(+t), n) : u
			}, n
		},
		hb = function () {
			var t, n = [];
		...
		db = function (t, n) {
			return Sx(t[0] - n[0]) < mx && Sx(t[1] - n[1]) < mx
		},
		vb = function (t, n, e, r, i) {
			var o, u, a = [],
				c = [];
		...
		Nb = function () {
			...
			function n() {
				return Ls(zx(o / _) * _, i, _).map(h).concat(Ls(zx(s / y) * y, c, y).map(p)).concat(Ls(zx(r / d) * d, e, d).filter(function (t) {
					return Sx(t % _) > mx
				}).map(f)).concat(Ls(zx(a / v) * v, u, v).filter(function (t) {
					return Sx(t % y) > mx
				}).map(l))
			}
			...
			var e = t[0] * kx,
				...
				_ = d ? function (t) {
					var n = Rx(t *= d) / v,
						...
						i = e * l + n * p,
						o = e * a + n * s;
					return [Ex(i, r) * Nx, Ex(o, Dx(r * r + i * i)) * Nx]
				} : function () {
					return [e * Nx, r * Nx]
				};
		...
		Cb = {
			...
			lineEnd: Ea,
			polygonStart: function () {
				Cb.lineStart = kc, Cb.lineEnd = Ec
			},
			polygonEnd: function () {
				Cb.lineStart = Cb.lineEnd = Cb.point = Ea, Ab.add(Sx(Eb)), Eb.reset()
			},
			result: function () {
				var t = Ab / 2;
				return Ab.reset(), t
		...
		Xb = {
			...
			lineEnd: Rc,
			polygonStart: function () {
				Xb.lineStart = Uc, Xb.lineEnd = Dc
			},
			polygonEnd: function () {
				Xb.point = zc, Xb.lineStart = Pc, Xb.lineEnd = Rc
			},
			result: function () {
				var t = Hb ? [Bb / Hb, jb / Hb] : Yb ? [Fb / Yb, Ib / Yb] : Ob ? [Ub / Ob, Db / Ob] : [NaN, NaN];
				return Ub = Db = Ob = Fb = Ib = Yb = Bb = jb = Hb = 0, t
			}
		};
	Ic.prototype = {
		_radius: 4.5,
		...
		point: function (t, n) {
			switch (this._point) {
				...
				case 1:
					...
					break;
				default:
					this._context.moveTo(t + this._radius, n), this._context.arc(t, n, this._radius, 0, Tx)
			}
		},
		result: Ea
	}, Yc.prototype = {
	...
	var Vb = function () {
			function t(t) {
				return t && ("function" == typeof o && i.pointRadius(+o.apply(this, arguments)), Yx(t, e(i))), i.result()
			}
			var n, e, r, i, o = 4.5;
			return t.area = function (t) {
				return Yx(t, e(Cb)), Cb.result()
			}, t.bounds = function (t) {
				return Yx(t, e(Rb)), Rb.result()
			}, t.centroid = function (t) {
				return Yx(t, e(Xb)), Xb.result()
			}, t.projection = function (r) {
				return arguments.length ? (e = null == (n = r) ? Sb : r.stream, t) : n
			}, t.context = function (n) {
		...
		$b = function (t, n) {
			...
			for (var a = 0, c = t.length; a < c; ++a)
				if (f = (s = t[a]).length)
					for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + Mx, d = Rx(p), v = Cx(p), _ = 0; _ < f; ++_, h = g, d = x, v = b, l = y) {
						var y = s[_],
							g = y[0],
							m = y[1] / 2 + Mx,
							x = Rx(m),
							...
							N = T > bx,
							k = d * x;
						if (Wb.add(Ex(k * M * Rx(T), v * b + k * Cx(T))), o += N ? w + M * Tx : w, N ^ h >= e ^ g >= e) {
							var S = Ia(Oa(l), Oa(y));
							ja(S);
							var A = Ia(i, S);
							ja(A);
				...
				var p, d, v, _ = n(o),
					...
					b = {
						...
						polygonEnd: function () {
							...
							var t = $b(p, y);
							d.length ? (x || (o.polygonStart(), x = !0), vb(d, Hc, t, e, o)) : t && (x || (o.polygonStart(), x = !0), o.lineStart(), e(null, null, 1, o), o.lineEnd()), x && (o.polygonEnd(), x = !1), d = p = null
						},
						sphere: function () {
			...
			function i(t) {
				...
				return {
					...
					point: function (l, h) {
						var p, d = [l, h],
							v = r(l, h),
							_ = c ? v ? 0 : u(l, h) : v ? u(l + (l < 0 ? bx : -bx), h) : 0;
						if (!n && (a = i = v) && t.lineStart(), v !== i && (p = o(n, d), (db(n, p) || db(d, p)) && (d[0] += mx, d[1] += mx, v = r(d[0], d[1]))), v !== i) f = 0, v ? (t.lineStart(), p = o(d, n), t.point(p[0], p[1])) : (p = o(n, d), t.point(p[0], p[1]), t.lineEnd()), n = p;
						else if (s && n && c ^ v) {
							var y;
						...
						}!v || n && db(n, d) || t.point(d[0], d[1]), n = d, i = v, e = _
					},
					lineEnd: function () {
						i && t.lineEnd(), n = null
					},
			...
			function o(t, n, e) {
				...
				if (!(m < 0)) {
					...
					var S = T - M,
						A = Sx(S - bx) < mx,
						E = A || S < mx;
					if (!A && k < N && (w = N, N = k, k = w), E ? A ? N + k > 0 ^ b[1] < (Sx(b[0] - M) < mx ? N : k) : N <= b[1] && b[1] <= k : S > bx ^ (M <= b[0] && b[0] <= T)) {
						var C = Ba(_, (-y + x) / g);
	...
	var Kb = 16,
		...
		iw = function () {
			return rw().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-.6, 38.7])
		},
		ow = function () {
			function t(t) {
				var n = t[0],
			...
			var n, e, r, i, o, u, a = iw(),
				c = rw().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
				s = rw().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
				f = {
					point: function (t, n) {
						u = [t, n]
					}
			...
			return t.invert = function (t) {
				...
				return n && e === t ? n : n = os([a.stream(e = t), c.stream(t), s.stream(t)])
			}, t.precision = function (n) {
				...
				return r = a.translate(n).clipExtent([
					...
					[u - .425 * e + mx, l + .12 * e + mx],
					[u - .214 * e - mx, l + .234 * e - mx]
				]).stream(f), o = s.translate([u - .205 * e, l + .212 * e]).clipExtent([
					[u - .214 * e + mx, l + .166 * e + mx],
					[u - .115 * e - mx, l + .234 * e - mx]
				]).stream(f), t
	...
	uw.invert = as(function (t) {
		return 2 * Sa(t / 2)
	});
	var aw = function () {
			return ns(uw).scale(124.75).clipAngle(179.999)
		},
		cw = us(function (t) {
			return (t = ka(t)) && t / Rx(t)
		});
	cw.invert = as(function (t) {
		return t
	});
	var sw = function () {
		return ns(cw).scale(79.4188).clipAngle(179.999)
	};
	cs.invert = function (t, n) {
		return [t, 2 * Ax(Px(n)) - wx]
	};
	var fw = function () {
			return ss(cs).scale(961 / Tx)
		},
		lw = function () {
	...
	vs.invert = as(Sa);
	var vw = function () {
		return ns(vs).scale(249.5).clipAngle(90 + mx)
	};
